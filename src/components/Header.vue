        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
              <div class="navbar-menu-container">
                <span class="navbar-link" v-text="'hello!   '+returnName" v-if="returnName"></span>
                <a href="javascript:void(0)" class="navbar-link" @click="loginModalFlag=true" v-if="!returnName">Login</a>
                <a href="javascript:void(0)" class="navbar-link" @click="logOut" v-if="returnName">Logout</a>
    ...
    login(){
         ...
         axios.post("/users/login",{userName:this.userName,userPwd:this.userPwd}).then((res)=>{
          ...
          if(res.status==0){
            this.errorTip = false;
            this.loginModalFlag = false;
            this.returnName=res.result.userName;
            this.getCartCount();
            }else{
              this.errorTip=true;
            }
