  ...
  <div class="container">
    <div class="checkout-addr">
      ...
      <div class="addr-list-wrap">
        <div class="addr-list">
          <ul>
            <li v-for="(item,index) in addressListFilter"v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index;selectedAddId=item.addressId">
              <dl>
                <dt>{{item.userName}}</dt>
                <dd class="address">{{item.streetName}}</dd>
                <dd class="tel">{{item.rel}}</dd>
              </dl>
      ...
      <div class="next-btn-wrap">
        <router-link class="btn btn--m btm--red"v-bind:to="{path:'orderConfirm',query:{'addressId':selectedAddId}}">Next</router-link>
         </div>
    </div>
  </div>
</div>
<modal :mdShow="isMdShow" @close="closeModal">
<p slot="message">确认删除地址</p>
<div slot="btnGroup">
