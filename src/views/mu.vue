...
<div class="container">
     <div class="picc">
      <img alt="" src="/static/wood1.jpg">
            <img alt="" src="/static/2.PNG"/>
                  <img alt="" src="/static/3.PNG"/>
                        <img alt="" src="/static/4.PNG"/>
                              <img alt="" src="/static/5.PNG"/>
                                    <img alt="" src="/static/6.PNG"/>
                                          <img alt="" src="/static/7.PNG"/>
                                                <img alt="" src="/static/8.PNG"/>
                                                      <img alt="" src="/static/9.PNG"/>
                                                            <img alt="" src="/static/10.PNG"/>
                                                                  <img alt="" src="/static/11.PNG"/>
                                                                        <img alt="" src="/static/12.PNG"/>
                                                                              <img alt="" src="/static/13.PNG"/>
    </div>
</div>
