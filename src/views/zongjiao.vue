...
<div class="container">
     <div class="picc">
      <img alt="" src="/static/zongjiao2.PNG"/>
      <model-obj src="/static/3.obj"></model-obj>
      <img alt="" src="/static/zongjiao.gif" />
      <model-obj src="/static/31.obj"></model-obj>
    </div>
</div>
	...
	export default{
		...
		components:{
          ...
          mounted() {
           ...
           methods:{
            init(){
          axios.get("/users/getStyle").then((res)=>{
               var res=res.data;
               this.styleList=res.result;
          })
        }
           }
	}
